...
資料        
    ...
    insert into item(isbn , dName , cCode , aName, pName , pDate)values(9586746384,'あい',1,'本田麻衣子','株式会社テック','1998-05-06');
    insert into item(isbn , dName, cCode , aName , pName , pDate,renCID )values(9845687212,'あき',4,'西山裕也','有限会社すまいる','2017-09-27',1);
    insert into item(isbn , dName, cCode , aName , pName , pDate,renCID)values(4589568795,'あくせさりー',7,'丸丘秀樹','菊池株式会社','2005-12-13',1);
    insert into item(isbn , dName , cCode , aName , pName , pDate,renCID)values(5687454980,'たちつてと',3,'JamesJohn','ABC株式会社','1965-04-27',1);
    insert into item(isbn , dName , cCode , aName, pName , pDate,renCID)values(9568326589,'なにぬねの',4,'サイトウカズコ','株式会社もぐもぐ','2014-06-18',1);
